...
def ResNet18(num_classes=10):
    return ResNet(3, BasicBlock, [2, 2, 2, 2], num_classes=num_classes)


def resnet(name, input_cahnnel, num_classes=10):
    """
    ...
    """
    if name == 'resnet18':
        return ResNet(input_cahnnel, BasicBlock, [2, 2, 2, 2], num_classes=num_classes)
    elif name == 'resnet34':
        return ResNet(input_cahnnel, BasicBlock, [3, 4, 6, 3], num_classes=num_classes)
    elif name == 'resnet50':
        return ResNet(input_cahnnel, Bottleneck, [3, 4, 6, 3], num_classes=num_classes)
    elif name == 'resnet101':
        return ResNet(input_cahnnel, Bottleneck, [3, 4, 23, 3], num_classes=num_classes)
